...
var axios = require("axios"); //here we pass some parameters and we use axios api to make the requests


var sendRequest = function sendRequest(url, method, data, headers) {
  var baseUrl = "http://localhost:3000";
  data = data || {};
  headers = headers || {};
  return axios({
    method: method,
    url: "".concat(baseUrl + url),
    data: data,
    headers: headers
  });
};
...
},{"axios":"node_modules/axios/index.js"}],"views/home.js":[function(require,module,exports) {
var requests = require("../helpers/requester");

var taskList = document.getElementsByClassName("taskList");

var taskController = require("../controllers/task-controller"); //here we take all tasks from db and everytme this function is called on the homescreen the tasks are up to date


var tasks = function tasks() {
  taskList[0].innerHTML = "";
  var addForm = document.getElementsByClassName("editForm");
  addForm[0].setAttribute("hidden", "true");
  var editForm = document.getElementsByClassName("addForm");
  editForm[0].removeAttribute("hidden");
  return requests.sendRequest("/tasks", "GET").then(function (result) {
    result.data.forEach(function (element) {
      var li = document.createElement("li");
      var editButton = document.createElement("button");
      editButton.innerText = "Edit";
      editButton.setAttribute("id", "".concat(element.id));
    ...
    console.log("This is an error from retreiving tasks from db: ".concat(err));
  });
};
...
},{"../helpers/requester":"helpers/requester.js","../controllers/task-controller":"controllers/task-controller.js"}],"helpers/helpers.js":[function(require,module,exports) {
var home = require("../views/home");

var requests = require("../helpers/requester"); //here we make PUT request to the db


exports.saveChanges = function (event) {
  var id = event.target.id;
  var taskToSave = document.getElementsByClassName("taskToSave");
  var data = {
    content: taskToSave[0].value
  };
  requests.sendRequest("/tasks/".concat(id), "PUT", data).then(function (result) {
    home.tasks();
  }).catch(function (err) {
    console.log("This is an error from modifying a recor in db: ".concat(err));
  });
...
exports.deleteTask = function (event) {
  var id = event.target.id;
  requests.sendRequest("/tasks/".concat(id), "DELETE").then(function (result) {
    home.tasks();
  }).catch(function (err) {
    console.log("This is an error from deleting a record in db: ".concat(err));
  });
};
},{"../views/home":"views/home.js","../helpers/requester":"helpers/requester.js"}],"controllers/task-controller.js":[function(require,module,exports) {
var requests = require("../helpers/requester");

var home = require("../views/home");

var helpers = require("../helpers/helpers"); //here we make POST request to DB
...
exports.addTaskPost = function () {
  ...
  requests.sendRequest("/tasks", "POST", data).then(function (result) {
    taskToAdd.value = "";
    home.tasks();
  }).catch(function (err) {
    console.log("This is an error from adding post to db: ".concat(err));
  });
...
exports.editTaskPost = function (event) {
  ...
  requests.sendRequest("/tasks/".concat(id)).then(function (result) {
    ...
    editForm[0].removeAttribute("hidden"); //here we set the input for editing

    var taskToSave = document.getElementsByClassName("taskToSave");
    taskToSave[0].value = result.data.content; //here we configure the delete button

    var deleteTaskButton = document.getElementsByClassName("deleteTask");
    deleteTaskButton[0].setAttribute("id", result.data.id);
    deleteTaskButton[0].addEventListener("click", helpers.deleteTask); //here we configure the save button

    var saveTask = document.getElementsByClassName("saveTask");
    saveTask[0].setAttribute("id", result.data.id);
    saveTask[0].addEventListener("click", helpers.saveChanges);
  }).catch(function (err) {
    console.log("This is an error from retreiving a record from db: ".concat(err));
  });
};
},{"../helpers/requester":"helpers/requester.js","../views/home":"views/home.js","../helpers/helpers":"helpers/helpers.js"}],"../../../../Users/x/AppData/Roaming/npm/node_modules/parcel/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"./bundle-url":"../../../../Users/x/AppData/Roaming/npm/node_modules/parcel/src/builtins/bundle-url.js"}],"public/css/typography.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../../../../Users/x/AppData/Roaming/npm/node_modules/parcel/src/builtins/css-loader.js"}],"public/css/styles.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
home.tasks(); //here we add an event to the Add button

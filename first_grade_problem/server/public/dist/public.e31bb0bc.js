...
exports.sendRequest = function (url, method, data, headers) {
  ...
  data = data || {};
  headers = headers || {}; //if the user is logged in we attach the authorization token to the header;

  if (storage.getData("authToken")) {
    var token = storage.getData("authToken");
...
},{"jquery":"node_modules/jquery/dist/jquery.js"}],"controllers/user-controller.js":[function(require,module,exports) {
"use strict";
...
exports.loginPost = function () {
  document.getElementById("loginForm").onsubmit = function (event) {
    ...
    _requester.default.sendRequest("/user/login", "POST", data).then(function (result) {
...
exports.randomDigit = function (range, quantity) {
  ...
  for (var index = 0; index < quantity * 2; index++) {
    var element = Math.ceil(Math.random() * (max - min) + min);
...
exports.createGame = function (arrNumbers, operation, quantity) {
  ...
  for (var index = 0; index < quantity * 2; index += 2) {
    var firstDigit = arrNumbers[index];
    var secondDigit = arrNumbers[index + 1];
    var answer = 0;
...
},{}],"controllers/game-controller.js":[function(require,module,exports) {
"use strict";

var _requester = _interopRequireDefault(require("../helpers/requester"));

var _gameGenerator = _interopRequireDefault(require("../helpers/game-generator"));
...
exports.gameSingleGenerate = function (html) {
  ...
  document.getElementById("singleGame").onsubmit = function (event) {
    ...
    var gameArr = _gameGenerator.default.createGame(digitArr, operation, quantity);
    ...
    _requester.default.sendRequest("/game/playboard", "GET").then(function (result) {
      ...
      document.getElementById("save-result").addEventListener("click", function () {
        _requester.default.sendRequest("/result/add:".concat(userId), "POST", gameResult).then(function (result) {
      ...
      console.log("This is an error from retreiving playboard from the back-end ".concat(err));
    });
  };
};
...
},{"./images\\background-math.jpg":[["background-math.80475661.jpg","styles/images/background-math.jpg"],"styles/images/background-math.jpg"],"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"styles/typography.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
if (currentPath === "/") {
  ...
  if (route) {
    ...
    if (url === "/logout") {
      _userController.default.logoutPost();
    } else {
      (0, _requester.sendRequest)(url, method).then(function (result) {
        var html = result.data;

        if (url === "/user/register") {
          _userController.default.registerGet(html);

          _userController.default.registerPost();
        } else if (url === "/user/login") {
          _userController.default.loginGet(html);

          _userController.default.loginPost();
        } else if (url === "/game/types") {
          _gameController.default.gameIndexGet(html);
        } else if (url === "/profile/stats") {
          _profileController.default.statsGet(html);
        } else if (url === "/standings/index") {
          _standingsController.default.standingsGet(html);
        } else if (url === "/game/single") {
          _gameController.default.gameSingleGet(html);

          _gameController.default.gameSingleGenerate();
        }
      }).catch(function (err) {
        console.log("backend error ".concat(err));
      });
